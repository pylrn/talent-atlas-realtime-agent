"""Transform InferencePrince555/Resume-Dataset into app candidate/document JSONL.
...
DATASET_URL = (
    "https://huggingface.co/datasets/InferencePrince555/Resume-Dataset/resolve/main/"
...
async def main() -> None:
    ...
    print(
        f"Transforming source=inference offset={args.offset}, "
